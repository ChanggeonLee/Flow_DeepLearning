...
shape = [128, 256]
# open the file
dataH5_0 = h5py.File("../testsample/fluid0.02.h5")
dataH5_1 = h5py.File("../testsample/fluid0.03.h5")
dataH5_2 = h5py.File("../testsample/fluid0.06.h5")
dataH5_3 = h5py.File("../testsample/fluid0.09.h5")
...
flow_3 = np.array(dataH5_3['Velocity_0'][:])
flow_3 = flow_3.reshape([shape[0], shape[1]+128, 3])[0:shape[0],0:shape[1],0:2]
